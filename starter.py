...
class HomePage(tk.Tk, object):
    ...
    def create_widgets(self):
        self.startButton =  tk.Button(self,text="calculate",command=self.startQLearning)
        self.startButton.place(x = 190,y = 130)    
        self.startPositionLabel= tk.Label(self,text = "Start point (XY) :").place(x = 40,y = 60)
        self.endPositionLabel = tk.Label(self,text="Target (XY)        :").place(x=40,y=100)
